...
public class SharedShoppingListEditorEntry implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		/*
		 * Für den weiteren Vorgang müssen noch folgenden Klassen und Interfaces implementiert werden:
		 * RemoteService
		 * Serverseitig: LoginService(.client) + LoginServiceAsync extends AsyncCallback callback
		 * LoginInfo (.client)
		 * LoginServiceImpl (.server)
		 * Anpassung web.xml
		 */
