...
public class SharedShoppingListEditorEntry implements EntryPoint {
	 ...
	 * Ueber den Button <code>loginButton</code> wird die Google-LoginMaske aufgerufen 
	 */
	private void loadLogin() {
		...
		loginButton.addClickHandler((ClickHandler)new LoginClickHandler());
	  	...
	  	/*
	 * Die nested Class <code> LoginClickHandler</code> implementiert das ClickHandler-Interface
	 * Durch einen Klick auf den loginButton wird der User auf die Google-LoginMaske weitergeleitet
	 */
