...
/**
 * Diese Klasse ist die Spalte eines <code>Row</code>-Objektes. Durch die
 * Implementierung des <code>Serializable</code>-Interfaces können die
 * <code>Column</code>-Objekte als Kopien z.B. vom Server an den Client
 * übertragen werden.
 * 
 * 
 * @author Nico Weiler
...
public class Column implements IsSerializable {
	...
	/**
	 * Der Wert eines Spaltenobjekts entspricht dem Zelleneintrag einer Tabelle. In
	 * dieser Realisierung handelt es sich um einen einfachen textuellen Wert.
	 */
	 ...
	 * </p>
	 * <p>
	 * Wenn jedoch eine Klasse mindestens einen explizit, implementierten
	 * Konstruktor besitzt, gelten auch nur die implementierten Konstruktoren und
	 * nicht mehr der Default-Konstruktor. Wird jedoch in dieser Klasse trotzdem ein
	 * No-Argument-Konstruktor benötigt, muss dieser explizit implementiert werden.
	 * </p>
	 * 
	 * @see #Column(String)
	...
	/**
	 * Hier wird der Wert der Spalte ausgelesen. -->Getter
	 * 
	...
	/**
	 * Hier wird der aktuelle Wert der Spalte überschrieben -->Setter
	 * 
	 * @param value
	 */
