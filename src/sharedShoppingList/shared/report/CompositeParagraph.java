...
/**
 * In dieser Klasse werden einzelne Absätze, also
 * <code>SimpleParagraph</code>-Objekte, dargestellt. Diese werden in einer
 * <code>ArrayList</code> als Unterabschnitte abgelegt und verwaltet.
 * 
 * @author Nico Weiler
 * @version 1.0
...
public class CompositeParagraph extends Paragraph implements Serializable {
	 ...
	 * 
	 * @return <code>ArrayList</code> alle enthaltenen Unterabschnitte werden
	 *         zurückgegeben.
	 */
	...
	public String toString() {
		...
		for (int i = 0; i < this.subParagraphs.size(); i++) {
			...
			/**
			 * Hier werden die jeweiligen Unterabschnitte in ein String umgewandelt und
			 * anschließend an den StringBuffer gehängt.
			 * 
			 */
		...
		/**
		 * Abschließend wird der Buffer in einen String umgewandelt und zurückgegeben.
		 * 
		 */
