 ...
 * </p>
 * <p>
 * Der ReportClient bietet die Möglichkeit, eine Menge von Berichten (Reports)
...
public interface ReportClient extends RemoteService {
	...
	/**
	 * Erstellen eines <code>AllListEntries</code>-Reports. Dieser Report-Typ stellt
	 * alle Artikel eines Einkäufers dar.
	 * 
	 * @param user eine Referenz auf das UserObject bzgl. dessen der Report erstellt
	 *             werden soll.
	 * @return das fertige Reportobjekt
	 * @throws IllegalArgumentException
	 * @see AllArticle
	 */
	public abstract AllListEntries createAllListEntriesByUserReport(User user) throws IllegalArgumentException;

	/**
	 * Erstellen eines <code>AllListEntriesByStore</code>-Reports. Dieser Report-Typ
	 * stellt alle eingekauften Artikel eines bestimmten Händlers dar.
	 * 
	 * @param store eine Referenz auf das StoreObject bzgl. dessen der Report
	 *              erstellt werden soll.
	 * @return das fertige Reportobjekt
