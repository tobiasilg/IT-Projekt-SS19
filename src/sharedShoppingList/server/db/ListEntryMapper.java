...
public class ListEntryMapper {
	...
	public ListEntry insert(ListEntry listEntry) {
		...
		String sql = "insert into article (id, name, createDate, modDate, amount, checked, userid, storeid, articleid, shoppinglistid) values ("
				+ listEntry.getId() + "," + listEntry.getName() + "," + listEntry.getCreateDate() + ","
				+ listEntry.getModDate() + "," + listEntry.getAmount() + "," + listEntry.isChecked() + ","
				+ listEntry.getUserId() + "," + listEntry.getStoreId() + "," + listEntry.getArticleId() + ","
				+ listEntry.getShoppinglistId() + ")";
