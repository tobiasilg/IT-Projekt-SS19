...
public class DBConnection {
	...
	/*
	 * Die folgende Variable speichert die einzige Instanz dieser Klasse. Sie ist
	 * nur einmal für sämtliche Instanzen vorhanden.
	 */
	private static Connection con = null;

	/**
	 * Über die folgende zwei URLs werden die Datenbanken angesprochen. Eine lokale
	 * zum Testen Eine in der Cloud (Google Cloud Plattform)
	 */
	...
	/**
	 * Singleton Eigenschaft wird sichergestellt indem nur eine Instanz von
	 * DBConnection vorhanden ist.
	 * 
	...
	public static Connection connection() {
		...
		if (con == null) {
			...
			try {
				 ...
				 * Class.forName("com.mysql.jdbc.GoogleDriver"); url = googleUrl; } else { //
				 * Local MySQL instance to use during development.
				 * Class.forName("com.mysql.jdbc.Driver"); url = localUrl; } /* Dann erst kann
				 * uns der DriverManager eine Verbindung mit den oben in der Variable url
