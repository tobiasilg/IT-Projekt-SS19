<<<<<<< HEAD:src/sharedShoppingList/server/EinkaufslistenverwaltungImpl.java
...
public class EinkaufslistenverwaltungImpl extends RemoteServiceServlet implements Einkaufslistenverwaltung {
	...
	/**
	 * Löschen eines Articles und damit entfernen des Article Tupel aus der DB Die
	 * Löschweitergabe sorgt dafür, dass auch Listeneinträge, welche den jeweiligen
	 * Artikel enthalten, gelöscht werden.
	 * 
	 * @param Article Objekt
	 */
...
>>>>>>> master:SharedShoppingList/src/sharedShoppingList/server/EinkaufslistenverwaltungImpl.java
